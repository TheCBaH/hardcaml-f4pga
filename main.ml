...
let build_clock () =
  ...
  let circuit =
    ...
    Circuit.create_exn ~name [ Signal.output "anode" anode; Signal.output "segment" segment ] in
...
let build_reset () =
  ...
  let circuit =
    ...
    Circuit.create_exn ~name [ Signal.output "reset" reset] in
  Rtl.output ~output_mode ~database:(Scope.circuit_database scope) Verilog circuit
...
let build_led () =
  ...
  let circuit =
    ...
    Circuit.create_exn ~name [ Signal.output "control" control] in
  Rtl.output ~output_mode ~database:(Scope.circuit_database scope) Verilog circuit
